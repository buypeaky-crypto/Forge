...
import { c as getModel, l as listModels, n as ModelCardSkeleton, r as Shell } from "./model-card-BHlZAPQR.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/router-DbVGXYSE.js
...
var styles_default = "/assets/styles-DUUrqCLV.css";
var APP_NAME = "Forge";
...
var $$splitComponentImporter$2 = () => import("./routes-CklrYG6z.mjs");
...
var $$splitComponentImporter$1 = () => import("./conduit-CBlHsYff.mjs");
var Route$1 = createFileRoute("/conduit")({ component: lazyRouteComponent($$splitComponentImporter$1, "component") });
var $$splitComponentImporter = () => import("./huggingface-Du6qCL0n.mjs");
var Route = createFileRoute("/huggingface")({
...
var rootRouteChildren = {
	...
	ConduitRoute: Route$1.update({
		id: "/conduit",
		path: "/conduit",
		getParentRoute: () => Route$3
	}),
	HuggingfaceRoute: Route.update({
		id: "/huggingface",
		path: "/huggingface",
		getParentRoute: () => Route$3
	})
