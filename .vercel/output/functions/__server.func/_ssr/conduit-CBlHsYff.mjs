...
import { l as listModels, r as Shell, t as ModelCard } from "./model-card-BHlZAPQR.mjs";
import { t as Button } from "./button-Da0z7tef.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/conduit-CBlHsYff.js
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Shell, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("main", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				...
				children: "Conduit inspects the prompt, picks a Hugging Face pipeline, then loads the most-downloaded models for that task."
			}),
