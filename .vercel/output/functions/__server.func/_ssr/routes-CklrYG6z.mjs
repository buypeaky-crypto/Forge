...
import { r as Search, s as ArrowRight } from "../_libs/lucide-react.mjs";
import { r as Shell, t as ModelCard } from "./model-card-BHlZAPQR.mjs";
import { t as Button } from "./button-Da0z7tef.mjs";
import { r as Route$2 } from "./router-DbVGXYSE.mjs";
import { t as Input } from "./input-DdasGKir.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/routes-CklrYG6z.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
function Home() {
	const featured = Route$2.useLoaderData();
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Shell, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("main", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				...
				children: "Forge indexes the public Hugging Face Hub and runs a lightweight Conduit router so each request lands on a fitting pipeline."
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("form", {
				className: "mt-8 flex max-w-xl flex-col gap-2 sm:flex-row sm:items-center",
				onSubmit: (e) => {
					e.preventDefault();
					navigate({
						to: "/huggingface",
